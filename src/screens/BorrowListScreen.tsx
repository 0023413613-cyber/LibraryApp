...
//         setBorrowList((current) =>
//           current.filter((borrow) => borrow.id !== item.id)
//         );
...
//         } else {
//           Alert.alert("Trả sách thành công", message);
//         }
//       } catch (e) {
//         console.log("Lỗi trả sách:", e);

//         if (Platform.OS === "web") {
//           window.alert("Không thể trả sách. Vui lòng thử lại.");
//         } else {
//           Alert.alert(
//             "Lỗi",
...
//         { text: "Trả sách", onPress: performReturn },
//       ]
//     );
//   };
...
//           style={[
//             styles.returnButton,
//             returningId === item.id && styles.returnButtonDisabled,
//           ]}
...
//             {returningId === item.id ? "Đang trả sách..." : "Trả sách"}
//           </Text>
//         </TouchableOpacity>
//       </View>
//     );
...
//                   Trả sách: {overdueCount} cuốn quá hạn
//                 </Text>
//               </View>
//             )}
